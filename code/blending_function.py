...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  6 13:43:31 2020
...
def blend_image(image1,image2,mask):
    (r1, g1, b1) = split_rgb(image1)
    (r2, g2, b2) = split_rgb(image2)
    rm, gm, bm = mask,mask,mask
    ...
    return result
def main_blend(orig_pattern, flipped_pattern, masked_img, save_name=None):
 
 image1 = cv2.imread(orig_pattern)
 image2 = cv2.imread(flipped_pattern)
 mask = cv2.imread(masked_img)
...
"""
main_blend(orig_pattern="C:/Users/chait/Desktop/image_warping/blending/new_code/pattern_4.jpg",
      flipped_pattern="C:/Users/chait/Desktop/image_warping/blending/new_code/pattern_4_flipped.jpg",
      masked_img="C:/Users/chait/Desktop/image_warping/blending/new_code/masked512.jpg")
"""
